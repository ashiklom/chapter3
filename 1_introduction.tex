...
% * <tmccabe@bu.edu> 2018-04-12T15:03:16.068Z:
% 
% > bellwethers
% Nice word choice
% 
...
% 
% ^ <emcowdery@gmail.com> 2018-04-12T06:26:28.887Z:
% 
% I mention this below in your questions section, but it was not clear to me until looking at methods and results that you would be comparing multiple versions of PROSPECT. 
%
% ^.
...
% * <tmccabe@bu.edu> 2018-04-12T15:06:30.279Z:
% 
% I'd first list all of the traits you're looking at in one sentence, then with  the rest of the paragraph/paragraphs go through and explain why each trait is important. I'd end with what information these traits provide taken together. 
% 
% ^.
...
% * <emcowdery@gmail.com> 2018-04-12T06:52:24.575Z:
% 
% > radiative transfer model
% add (RTM)  
% You never actually define RTMs in this chapter. In the previous chapter you do - maybe just site that? Or at least include "Radiative transfer models (RTMs) provide a mechanistic link between vegetation properties and observed spectral features" (directly plagiarized from Ch 2) since you go on to talk specifically about mechanistic v. empirical. 
% 
% ^.
% * <fer.istem@gmail.com> 2018-04-11T19:57:04.472Z:
% 
% did you study these traits because they can be used in PROSPECT or did you choose to study these traits and PROSPECT happened to be using them? are there other RTMs using different traits? why not those triats/RTMs?
% 
% If you chose to work with PROSPECT and those were the traits PROSPECT  uses, then this paragraph should come before the "six foliar optical traits" paragraph, or maybe merged?
% 
% ^ <tmccabe@bu.edu> 2018-04-12T15:09:02.899Z:
% 
% +1. 
%
% ^.
...
% * <emcowdery@gmail.com> 2018-04-12T19:04:15.441Z:
% 
% > First, RTM inversion can be applied to virtually any instrument, because the spectra simulated by RTMs can then be downsampled to any spectral resolution based on the spectral response curve of the corresponding instrument.
% 
% Add in what you just said about "spectra are just spectra!"
% 
% ^.
...
% * <tmccabe@bu.edu> 2018-04-12T15:10:14.691Z:
% 
% > Second, the ability of RTMs to forward-simulate vegetation-light interactions makes them valuable to other applications, such as modeling leaf absorbance for photosynthesis and for improving representations of energy balance in terrestrial biosphere models (CITE, Fisher 2017?).
% Is this something you follow up on, or is it just a separate cool application?
% 
% ^.
...
% * <emcowdery@gmail.com> 2018-04-12T05:55:00.716Z:
% 
% > empirical approaches
% I was going to say you should perhaps expand a bit more on why empirical models leave something to be desired (parameters that do not correlate to anything that's biologically meaningful) but then you immediately go on to say that the majority of the parameters in the PROSPECT RTM are in fact empirical - and so while the rest of the sentence makes sense, I might not pit PROSPECT specifically against "empirical models"
% 
% ^.
...
% * <fer.istem@gmail.com> 2018-04-11T20:11:46.153Z:
% 
% following Mike's comment, I'm a bit confused about the focus of the paper. Is it validation of PROSPECT or investigation of foliar trait variability?
% Also not sure how well intro leads to the questions listed here. Nothing motivated me to think about exposure to pathogens or using traits to group species into functional types (although maybe former chapters mentioned these)
% 
% I'm liking the title of this chapter, but I still don't know why we want to know about foliar trait variability at individual to global scales (but I know that leaf optical properties will shine light to it!)
% 
% ^ <emcowdery@gmail.com> 2018-04-12T06:14:23.794Z:
% 
% Agreed, it seems like there are two groups of questions: ones that involve PROSPECT and one's that don't. Answers to all the questions will no doubt be improved (and/or be made possible to answer) by the fact that you've compiled the large database. Has what you've learned using PROSPECT helped form the other questions? So I see #1 leading to #3, but like Istem said, #2 needs more motivation.
% 
% ^.
...
% * <emcowdery@gmail.com> 2018-04-12T06:21:56.104Z:
% 
% > PROSPECT
% It was not clear to me until looking at methods and results that you would be comparing multiple versions of PROSPECT. That seems like the intermodel comparison aspect of the project would be something you want to highlight in the introduction.
% 
% ^.
...
% 
% ^ <emcowdery@gmail.com> 2018-04-12T06:18:33.839Z:
% 
% perhaps some of this can be moved earlier to explain more of the thought process that leads to the questions. 
%
% ^.
