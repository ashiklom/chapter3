...
\end{figure}
% * <fer.istem@gmail.com> 2018-04-12T12:06:02.949Z:
% 
% Feels like these figures are too big with little information
% no need to change but just wanted to note that it might be nice to have a more summarizing figure like fig.13 or fig15 so that all can be seen in one figure without needing to go between figures
% 
% ^.
...
\begin{figure}
  ...
  \caption{\
    ...
    Each value is the percent fixed effect on the corresponding trait as estimated from a linear fixed-effects model.
% * <dietze@bu.edu> 2018-04-11T13:17:30.095Z:
% 
% > Each value is the percent fixed effect
% How can some traits explain >100% of the variability? How can others explain negative variability?
% 
% ^.
...
% * <dietze@bu.edu> 2018-04-11T13:15:48.085Z:
% 
% > declines in leaf number of mesophyll layers
% Drop "leaf"
% 
% ^.
...
% * <dietze@bu.edu> 2018-04-11T14:12:40.757Z:
% 
% > ---GLMA4---
% what is this?
% 
