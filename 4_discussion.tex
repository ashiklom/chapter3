...
% * <emcowdery@gmail.com> 2018-04-12T06:44:38.704Z:
% 
% > overall $R^2$ for all traits was
% Which tense are you using? *the* overall R2 *value* was,  overall R2 *values were*?
% 
% ^.
...
% 
% ^.
% * <fer.istem@gmail.com> 2018-04-12T13:03:31.443Z:
% 
% given all the shortcomings, I wonder if this paragraph could still be made more positive
% given your title and your advocacy of RTMs in the intro, I think a more positive beginning to the discussion might help..or you might consider revising the title and the tone of intro as well, in lines of "we think RTM inversions are the way to go but we're skeptical of their current state and provide a comprehensive evaluation and roadmap for future development in this paper" etc
% 
% ^ <tmccabe@bu.edu> 2018-04-12T15:30:57.022Z:
% 
% +1.  The end of your results was optimistic " covariation was strongly species specific, but substantial" . More useful than  dismissing your results would be to list the contexts where they could be helpful. Even defining the limitation is more useful than outright dismissal.   
%
% ^.
...
% * <emcowdery@gmail.com> 2018-04-12T06:49:33.822Z:
% 
% I would add this motivation (more explicitly) to the introduction. 
% 
% ^.
...
% * <emcowdery@gmail.com> 2018-04-12T07:01:18.782Z:
% 
% > using
% to use
% 
...
% * <tmccabe@bu.edu> 2018-04-12T15:32:42.198Z:
% 
% > had larger effects on optical traits.
% Than what? Restate. 
% 
% ^.
